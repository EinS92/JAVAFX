...
public class LoanCalculator extends Application {
    ...
    @Override //Override the start method in the method in the Application class
    public void start(Stage primaryStage) {
        ...
        gridPane.add(tfAnnualInterestRate, 1, 0);       //gridPane.add(node, columnIndex, rowIndex, colspan, rowspan)
